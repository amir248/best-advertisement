...
function openMenu(){
  if(window.innerWidth<=700){
    const listA=['<a href="/">Main</a>','<a href="/about">О нас</a>','<a href="/#services">Услуги</a>','<a href="/#pricing">Цены</a>','<a href="/#contacts">Контакты</a>','<a href="/proposal">Предложение</a>','<a href="/commercial-offer">Коммерческий офер</a>'];
  function createMenu(){
