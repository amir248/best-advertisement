...
function openMenu(){
  if(window.innerWidth<=700){
    const listA=['<a href="/">Main</a>','<a href="/about">О нас</a>','<a href="/#services">Услуги</a>','<a href="/#pricing">Цены</a>','<a href="/#contacts">Контакты</a>','<a href="/proposal">Предложение</a>','<a href="/commercial-offer">Коммерческий офер</a>','<a href="/Commercial-proposal-for-Chinese-companies-operating-in-Russia-and-Siberia">Offer для китайской компании в России</a>','<a href="/help">Amir HELP</a>','<a href="/why-us">Почему мы?</a>','<a href="/survival-memo">Survival Memo</a>','<a href="/privacy-policy">Политика конфиденциальности</a>'];
  function createMenu(){
